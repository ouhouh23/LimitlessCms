...
<section class="section section_default">
  <div class="section__text">
    <a class="caps caps_regular section__description">
      our mission
    </a>
    ...
    <p class="paragraph_base paragraph_heavy section__paragraph">
    ...
    <a href="#" class="scroll-button section__scroll">
...
<section class="section section_default">
  <div class="section__text">
    <a href="#" class="scroll-button section__scroll section__scroll_top">
      <img src="/wp-content/themes/limitless/assets/images/icons/scroll-button.svg" alt="scroll button" class="scroll-button__icon" />
    </a>
  ...
  <img 
    src="/wp-content/themes/limitless/assets/images/section/section-3.png"
    alt="section image"
    class="section__image"
    width="700"
    height="700"
...
<section class="section section_default">
  <div class="section__text">
    ...
    <h1 class="display_small heading_heavy section__heading">
  ...
  <img 
    src="/wp-content/themes/limitless/assets/images/section/section-4.png"
    alt="section image"
    class="section__image"
    width="700"
    height="700"
...
<section class="section section_default">
  ...
  <img 
    src="/wp-content/themes/limitless/assets/images/section/section-5.png"
    alt="section image"
    class="section__image"
    width="700"
    height="700"
...
<section class="section section_default">
  ...
  <img 
    src="/wp-content/themes/limitless/assets/images/section/section-6.png"
    alt="section image"
    class="section__image"
    width="700"
    height="700"
...
<section class="offer wrapper">
  <div class="offer__container">
    <h2 class="heading_xl heading_heavy offer__heading">
    ...
    <div class="offer__buttons">
      <button
        type="button"
        class="button button_medium button_primary button_ghost offer__button" 
      >
        Get involved
      </button>
