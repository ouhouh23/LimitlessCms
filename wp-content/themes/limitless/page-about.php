...
<section class="hero wrapper">
  ...
  <div class="hero__body">
    ...
    <img 
      src="/wp-content/themes/limitless/assets/images/hero/hero-1.png" 
      alt="hero image" 
      class="hero__image"
      width="846"
      height="630"
...
<section class="section section_default section_illustrated">
  <div class="section__text">
    <h2 class="display_small heading_heavy section__heading">
      We exist for your <br> success.
    </h2>

    <button  
      type="button" 
      class="button button_large button_primary button_ghost section__button">
...
<section class="collection collection_rounded wrapper">
  <header class="header collection__header">

    <h2 class="display_small heading_heavy header__heading">Our <span class="header__underline">Team</span></h2>
...
<section class="collection wrapper">
  <header class="header collection__header">
    ...
    <p class="paragraph_base paragraph_regular header__text">
      Updates. Press Releases. Stories. See what we've been up to at 
      Limitless!Blog posts are written by out team and guests.
    </p> 
  </header>
