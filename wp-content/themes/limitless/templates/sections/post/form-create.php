<section class="form <?= $class ?> wrapper">
  ...
  <form id="test" class="form__body" method="POST" enctype="multipart/form-data" data-post-form data-post-form-create>
    <?php
    ...
    <div class="form__item file">
      ...
      <input class="visially-hidden" type="file" id="file" name="post_image" />
